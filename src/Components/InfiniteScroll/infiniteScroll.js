...
export default function InfiniteScroll() {
    ...
    const infiniteFetchData = () => {
        ...
        fetch(`https://api.unsplash.com/search/photos?page=${pageIndex}&per_page=30&query=${searchState}&client_id=JTLRNRtbBHd_6ijARh7DkQep2ua8xttUC4WYSnGCsfg`).then((response) => {
